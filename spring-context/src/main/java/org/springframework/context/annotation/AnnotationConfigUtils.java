...
public abstract class AnnotationConfigUtils {
	...
	public static Set<BeanDefinitionHolder> registerAnnotationConfigProcessors(
		...
		if (beanFactory != null) {
			...
			/**
			 * beanFactory.getAutowireCandidateResolver() 默认值为 SimpleAutowireCandidateResolver.INSTANCE
			 */
		 ...
		 * 4、org.springframework.orm.jpa.support.PersistenceAnnotationBeanPostProcessor
		 * 5、EventListenerMethodProcessor.class
		 * 6、DefaultEventListenerFactory.class
		 *
		 * 类注册到容器的 BeanDefinitionMap
		 */
	...
	/**
	 * 向 beanDefinitionMap 集合中注入 beanName 对应的类
	 *
	 * @param registry
	 * @param definition
	 * @param beanName
